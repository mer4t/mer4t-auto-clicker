...
public class AutomationEngineTests
{
    ...
    private sealed class FailsOnScrollInputInjector : m4AutoClicker.Application.Abstractions.IInputInjector
    {
        public bool ReleaseCalledAfterFailure { get; private set; }

        public m4AutoClicker.Application.Models.InputInjectionResult MoveMouse(m4AutoClicker.Domain.Display.ScreenPoint point) =>
            new(true, 1, 1, null, null);

        public m4AutoClicker.Application.Models.InputInjectionResult MouseDown(MouseButton button) =>
            new(true, 1, 1, null, null);

        public m4AutoClicker.Application.Models.InputInjectionResult MouseUp(MouseButton button)
        {
            ReleaseCalledAfterFailure = true;
            return new m4AutoClicker.Application.Models.InputInjectionResult(true, 1, 1, null, null);
        }

        public m4AutoClicker.Application.Models.InputInjectionResult Scroll(int delta) =>
            new(false, 1, 0, 1, "Test hatası: SendInput engellendi.");

        public m4AutoClicker.Application.Models.InputInjectionResult KeyDown(ushort keyCode) =>
            new(true, 1, 1, null, null);

        public m4AutoClicker.Application.Models.InputInjectionResult KeyUp(ushort keyCode) =>
            new(true, 1, 1, null, null);
    }
}
